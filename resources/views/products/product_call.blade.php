                                   ...
                                   @foreach($products as $key => $product)
                                       <!--  @if (count($product)>0) -->
                                        <tr>
                                            ...
                                            <th><a class="btn btn-small btn-success btn-block btn-flat call_product" value="{{ $product->id }}" href="#">edit</a></th>
              ...
              <div class="modal-header">
                ...
                <div class="modal-body" id="call_modal">
                    <form id="frmProducts" name="frmProducts">
                            <div class="col-sm-4">
                                <label>title:</label>
                                <input type="text" class="form-control black" id="call_title" name="title" required>
                            </div>
                            ...
                            <div class="col-sm-8">
                              <label>description:</label>  
                                <textarea class="form-control txetara" id="call_description" name="description"></textarea>
                            </div>
                    </form>    
                </div>  
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">no</button>
                    <input type="submit" class="btn btn-info btn-call" value="save">
